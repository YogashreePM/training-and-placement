...
PreparedStatement pst=null;
    ...
    public STUDENTLOGIN() {
        initComponents();
          connect = (com.mysql.jdbc.Connection)TraningandPlacement.connDB();
    }
    ...
    String Password= String.valueOf(jPasswordField1.getPassword());
        if (Password.equals("")) {
          ...
          String sql= "select * from stu_reg where user_name= '" + jTextField1.getText() + "' and password ='" + jPasswordField1.getText() + "'";
      try
      {
