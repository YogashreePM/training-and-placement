...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jButton5.setText("recuirtment student details");
        ...
        jButton6.setText("training student details");
 ...
 try
      {
          String sql="delete from company where usn='"+jTextField1.getText()+"'";
      
        Statement s=connect.createStatement();
        
       s.executeUpdate(sql);
        
                JOptionPane.showMessageDialog(null," COMPANY Records Deleted Succssfully... ");
       jTextField1.setText("");
      jTextField2.setText("");
      jTextField3.setText("");
      jTextField4.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
           try {
Statement s=connect.createStatement();
String sql = "insert into company values('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"')";
s.executeUpdate(sql);
...
System.out.println("errorrr");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      try
      {
          String sql="select * from company where usn='"+jTextField1.getText()+"'";
        ...
        if(rst.next()==false)
        {
                JOptionPane.showMessageDialog(null," No Such Records of COMPANY FOUND ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       try
      {
          ...
          String sql="update company set Name='"+jTextField2.getText()+"',Address='"+jTextField3.getText()+"',Dob='"+jTextField4.getText()+"',Sex='"+jTextField5.getText()+"'  where USN='"+jTextField1.getText()+"'";
